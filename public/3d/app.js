...
function createPlaneGroup(){
    ...
    createPlane(-25, startPosY - 20, "advanced_cosmetic_dentistry", "/3Dwebsite/public/img/websites/advanced_cosmetic_dentistry.jpg")
    createPlane(0, startPosY - 20, "retro_express", "/3Dwebsite/public/img/websites/retro_express.jpg")
    createPlane(25, startPosY - 20, "dr_maieve", "/3Dwebsite/public/img/websites/dr_maieve.jpg")

    createPlane(-25, startPosY - 40, "dr_alison_black", "/3Dwebsite/public/img/websites/dr_alison_black.jpg")
    createPlane(0, startPosY - 40, "atlas_vein", "/3Dwebsite/public/img/websites/atlas_vein.jpg")
    createPlane(25, startPosY - 40, "galleria", "/3Dwebsite/public/img/websites/galleria.jpg")

    createPlane(-25, startPosY - 60, "spiced", "/3Dwebsite/public/img/websites/spiced.jpg")
    createPlane(0, startPosY - 60, "dr_perron", "/3Dwebsite/public/img/websites/dr_perron.jpg")
    createPlane(25, startPosY - 60, "schlessinger", "/3Dwebsite/public/img/websites/schlessinger.jpg")

    createPlane(-25, startPosY - 80, "static_address", "/3Dwebsite/public/img/websites/static_address.jpg")
    createPlane(0, startPosY - 80, "tsrh_home", "/3Dwebsite/public/img/websites/tsrh_home.jpg")
    createPlane(25, startPosY - 80, "urogynecology_center", "/3Dwebsite/public/img/websites/urogynecology_center.jpg")


    createPlane(0, startPosY - 120, "about_mf", "/3Dwebsite/public/img/about_me/brandenburg_tor.jpg", true)


    createPlane(-25, startPosY - 160, "gentle_dental", "/3Dwebsite/public/img/websites/gentle_dental.jpg")
    createPlane(0, startPosY - 160, "mcdowell", "/3Dwebsite/public/img/websites/mcdowell.jpg")
    createPlane(25, startPosY - 160, "dental_phobia", "/3Dwebsite/public/img/websites/dental_phobia.jpg")

    createPlane(-25, startPosY - 180, "belcor_builders", "/3Dwebsite/public/img/websites/belcor_builders.jpg")
    createPlane(0, startPosY - 180, "dfw_spine", "/3Dwebsite/public/img/websites/dfw_spine.jpg")
    createPlane(25, startPosY - 180, "centerderm", "/3Dwebsite/public/img/websites/centerderm.jpg")

    createPlane(-25, startPosY - 200, "smiles_4_a_lifetime", "/3Dwebsite/public/img/websites/smiles_4_a_lifetime.jpg")
    createPlane(0, startPosY - 200, "tennessee_vein", "/3Dwebsite/public/img/websites/tennessee_vein.jpg")
    createPlane(25, startPosY - 200, "the_vein_clinic", "/3Dwebsite/public/img/websites/the_vein_clinic.jpg")

    createPlane(-25, startPosY - 220, "priest_dental", "/3Dwebsite/public/img/websites/priest_dental.jpg")
    createPlane(0, startPosY - 220, "retinal_san_antonio", "/3Dwebsite/public/img/websites/retinal_san_antonio.jpg")
    createPlane(25, startPosY - 220, "eye_surgery_center", "/3Dwebsite/public/img/websites/eye_surgery_center.jpg")
